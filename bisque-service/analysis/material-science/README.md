...
{% content-ref url="../maasai-mara/mara-animal-annotator.md" %}
[mara-animal-annotator.md](../maasai-mara/mara-animal-annotator.md)
{% endcontent-ref %}

* Module to Detect Animals using AI

{% content-ref url="../maasai-mara/mara-animal-detector.md" %}
[mara-animal-detector.md](../maasai-mara/mara-animal-detector.md)
{% endcontent-ref %}

* Module to Evaluate a machine learning model

{% content-ref url="../maasai-mara/mara-evaluator.md" %}
[mara-evaluator.md](../maasai-mara/mara-evaluator.md)
{% endcontent-ref %}

* Module to generate report on a given dataset

{% content-ref url="../maasai-mara/mara-report-generator.md" %}
[mara-report-generator.md](../maasai-mara/mara-report-generator.md)
{% endcontent-ref %}

* Module to Retrain the AI Model

{% content-ref url="../maasai-mara/train-a-new-detector.md" %}
[train-a-new-detector.md](../maasai-mara/train-a-new-detector.md)
{% endcontent-ref %}
